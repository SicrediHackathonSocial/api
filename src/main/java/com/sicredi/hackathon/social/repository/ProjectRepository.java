...
public interface ProjectRepository extends JpaRepository<ProjectEntity, Long> {
    ...
    //@Query("SELECT project FROM ProjectEntity project WHERE project.owner.username != :username AND AND project.type = com.sicredi.hackathon.social.domain.ProjectType.PUBLIC")
